...
import { CREATE_EVENT_CATEGORY, Get_getEventCategory, UPDATE_EVENT_CATEGORY } from '../../../service/event.service';
...
export class ResigterEventCategoryComponent implements OnInit {
  ...
  showToast(position: NbGlobalPosition, status: NbComponentStatus) {
    this.toastrService.show('', this.translateService.translate("biz.eventcategory.confirm.validate"), {
      position,
      status,
    });
  }
